...
def turtle_in_color(color):
    ...
    # Draw a simple turtle shape (circle for the segments and smaller circles for the legs and head)
    draw.ellipse((10, 10, 40, 40), fill=color)  # Body
    draw.ellipse((40, 20, 50, 30), fill=color)  # Head
    ...
    draw.ellipse((5, 5, 15, 15), fill=color)    # Leg 4
